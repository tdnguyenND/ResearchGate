...
insert into Recruitment(career,amount,salary, language,requirement,advantage,type_of_work) values
('fresher','10','4,500,000 VNĐ', 'C','từng làm đồ án web sử dụng ASP.NET MVC, Entity Framework ;năng động, sáng tạo, ham học hỏi,...','tăng lương cơ bản 2 lần/năm,Thưởng tết và các dịp lễ, du lịch hằng năm theo chế độ của công ty,...','Fulltime'),
('managers','5','20,000,000 VNĐ', 'Java','Nắm vững và thành thạo ngôn ngữ lập trình web php, javascript, html,css; Có tư duy logic tốt, đam mê yêu thích công việc lập trình, chủ động trong công việc','tăng lương 2 lần /năm,du lịch hàng năm,...','Fulltime'),
('fresher','30','6,000,000 VNĐ', 'Python','từng làm dự án , bài tập lớn sử dụng Ruby,PHP,...','có tháng lương thứ 13, tăng lương 6 tháng 1 lần, được đi du lịch hàng năm','Fulltime')
;
...
insert into Application(user_id, experience,foreign_language,social_activities,special_skills,career_objective) values
(1, '1 năm kinh nghiệm làm PHP, thành thạo HTML,CSS,JS','English','Dạy học cho trẻ em','Khả năng lãnh đạo','PHP developer'),
